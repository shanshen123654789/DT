...
if st.button("Predict"):
    ...
    # 根据概率值添加相应的建议文本
    if probability >= 80:
        additional_text = "\n Recommendation: Strong candidate for breeding"
    elif probability <= 65:
        additional_text = "\n Recommendation: Consider culling"
    else:
        additional_text = "\n Recommendation: Potential backup option"

    # 显示预测结果，使用 Matplotlib 渲染指定字体
    text = f"Based on feature values, predicted possibility of high growth rate is {probability:.2f}%{additional_text}"
